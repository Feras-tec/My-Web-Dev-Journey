      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col items-center text-center mb-16">
          <div className="relative mb-4 group">
            ...
            <img
              src="/feras.jpg"
              alt="Feras - Full-Stack Web Developer Portfolio"
          ...
          {projectList.map((project, index) => (
            ...
            >
              ...
              <figure className="relative h-48 w-full bg-base-300 overflow-hidden border-b border-base-300">
                <img
                  src={project.image}
                  alt={`Desktop application layout preview of ${project.title}`}
              ...
              <div className="card-body p-6 justify-between">
                <div>
                  ...
                  <div className="flex justify-between items-center mb-4">
                    <div className="text-red-500/90">
                      <Folder size={28} aria-hidden="true" focusable="false" />
                    </div>
                  ...
                  {/* Content - Pure high contrast lines */}
                ...
                {/* Tech Badges with high contrast and explicit textual color */}
                <div className="flex flex-wrap gap-2 mt-auto">
                  {project.tech.map((techItem, idx) => (
                    <span
                      key={idx}
                      className="badge badge-sm badge-outline font-mono font-bold text-xs py-2.5 px-2.5 text-base-content border-base-300 bg-base-200/50 transition-all duration-300 hover:bg-red-500 hover:text-white hover:border-red-500 hover:shadow-[0_0_10px_rgba(239,68,68,0.3)]"
                    >
                      {techItem}
                    </span>
                  ))}
